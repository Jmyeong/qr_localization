...
# LPF 선언
lpf_x = LowPassFilter(alpha=0.1)
lpf_y = LowPassFilter(alpha=0.1)
lpf_z = LowPassFilter(alpha=0.1)
...
class RobotPositionNode(Node):
    ...
    def process(self):
        ...
        qr_roll, qr_pitch, qr_yaw = self.read_orientation_from_file("/home/jm/jm_ws/src/qr_localization/global/global_pose.txt", self.index)
        qr_x, qr_y = self.read_position_from_file("/home/jm/jm_ws/src/qr_localization/global/global_pose.txt", self.index)
